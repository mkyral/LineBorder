...
(script-fu-register
    ...
    SF-ADJUSTMENT "Total border size (width in pixels)" '(25 0 400 1 0 2 0)
    SF-ADJUSTMENT "Total border size (height in pixels)" '(25 0 400 1 0 2 0)
